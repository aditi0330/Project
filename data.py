...
#download dataset from tensorflow.org
...
def split_dataset(BASE_PATH = 'flower_photos', DATASET_PATH = 'dataset', train_images = 300, val_images = 50):
    # Specifying path to the downloaded folder
    classes = os.listdir(BASE_PATH)

    # Specifying path for copying the dataset into train and val sets
    ...
    for class_name in classes:
        ...
        # Creating destination folder (train and val) directories
...
def get_dataset_stats(DATASET_PATH = 'dataset'):
    """
        ...
        AVG_IMG_HEIGHT: Average height of images across complete dataset (including. train and val)
